...
""".replace("@REPLACE_A",a_string).replace("@REPLACE_B",b_string)
    file_path = 'capital-trend-qqq.html'
...
""".replace("@REPLACE_A",a_string).replace("@REPLACE_B",b_string)
    file_path = 'capital-trend-sqqq.html'
...
""".replace("@REPLACE_A",a_string).replace("@REPLACE_B",b_string)
    file_path = 'capital-trend-tqqq.html'
